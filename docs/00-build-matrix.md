...
| checkoutservice | Go 1.25.0 (toolchain 1.27.0) | `src/checkoutservice` | `src/checkoutservice/Dockerfile` | `gcr.io/distroless/static` (unpinned) | 5050 | gRPC | `boutique/checkoutservice` |
...
| frontend | Go 1.25.0 (toolchain 1.27.0) | `src/frontend` | `src/frontend/Dockerfile` | `gcr.io/distroless/static` (unpinned) | 8080 | HTTP | `boutique/frontend` |
...
| productcatalogservice | Go 1.25.8 (toolchain 1.27.0) | `src/productcatalogservice` | `src/productcatalogservice/Dockerfile` | `gcr.io/distroless/static` (unpinned) | 3550 | gRPC | `boutique/productcatalogservice` |
...
| shippingservice | Go 1.25.0 (toolchain 1.27.0) | `src/shippingservice` | `src/shippingservice/Dockerfile` | `gcr.io/distroless/static` (unpinned) | 50051 | gRPC | `boutique/shippingservice` |
...
5. **Unpinned images to fix in our overlays (not in the upstream Dockerfiles):** four `gcr.io/distroless/static` finals and `redis:alpine` are mutable; our GitOps overlays pin by digest.
